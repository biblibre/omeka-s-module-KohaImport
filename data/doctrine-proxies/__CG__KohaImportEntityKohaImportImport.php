 ...
 */
class KohaImportImport extends \KohaImport\Entity\KohaImportImport implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'job', 'name', 'owner', 'sites', 'config'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (KohaImportImport $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setOwner(\Omeka\Entity\User $user)
    {
